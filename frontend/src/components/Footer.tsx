...
const Footer = () => {
  ...
  return (
    <footer className="mt-auto py-6 md:py-8 border-t-0 bg-foreground">
      <div className="max-w-7xl mx-auto px-3 md:px-4">
        ...
        {networks.length > 0 && (
          <div className="flex flex-row items-center justify-center gap-5 mt-4 md:mt-6">
        ...
        <div className="text-center mt-4 md:mt-6 text-sm text-white/70">
